    ...
    def calculate_signals(self, event, **kwargs) -> List[SignalEvent]:
        ...
        if event.type == "MARKET":
            ...
            if "historical_fair_prices" in kwargs:
                kwargs["historical_fair_prices"][symbol].append(
                    dict(
                        fair_bid=fair_bid,
                        fair_ask=fair_ask,
